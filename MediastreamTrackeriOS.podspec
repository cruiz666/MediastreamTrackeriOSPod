...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/cruiz666/MediastreamTrackeriOS.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'MediastreamTrackeriOS/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MediastreamTrackeriOS' => ['MediastreamTrackeriOS/Assets/*.png']
  # }
